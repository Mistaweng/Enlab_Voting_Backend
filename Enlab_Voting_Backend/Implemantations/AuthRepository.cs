...
using Enlab_Voting_Backend.Helpers;
using RandomNumberGenerator = Enlab_Voting_Backend.Helpers.RandomNumberGenerator;
...
namespace Enlab_Voting_Backend.Implemantations
{
	public class AuthRepository : IAuthRepository
	{
		...
		public AuthRepository(IConfiguration configuration, RoleManager<AppUserRole> roleManager, ApplicationDbContext Db, UserManager<AppUser> userManager)
		{
